...
const DEFAULT_SWAP_TO_TOKEN_ITEM_BY_CHAIN_SERVER_ID: Record<string, TokenItem> =
  {
    avax: {
    ...
    eth: {
      ...
      credit_score: 18070867.627631955,
      time_at: 1533324504,
      is_verified: true,
      is_core: true,
      is_wallet: true,
...
export const getDefaultSwapToTokenItem = (
  chain?: CHAINS_ENUM | string,
): TokenItem | undefined => {
