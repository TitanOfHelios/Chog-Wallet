...
export function ModalConfirmAllowTransfer({
  ...
  >(async () => {
    ...
    if (isUseCustomPwd && !passwordIsAutoGenerated) {
    ...
    } else if (isUseBuiltinPwd || passwordIsAutoGenerated) {
      if (toAddr && confirmToAddToWhitelist) {
  ...
  const shouldDisabled =
    currentAuthType === 'password'
      ? isUseCustomPwd && !passwordIsAutoGenerated && shouldDisabledDueToForm
      : false;
