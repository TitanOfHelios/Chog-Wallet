...
import { Lazy } from 'react-native-collapsible-tab-view/src/Lazy';
import {
  MaterialTabBar,
  TABBAR_HEIGHT,
} from 'react-native-collapsible-tab-view/src/MaterialTabBar';
import { Tab } from 'react-native-collapsible-tab-view/src/Tab';
import {
  IS_IOS,
  ONE_FRAME_MS,
  scrollToImpl,
} from 'react-native-collapsible-tab-view/src/helpers';
import {
...
export const MultiAssetsContainer = React.memo(
  ({
    ref,
    initialTabName,
    ...
    const pageScrollHandler = usePageScrollHandler({
      onPageScroll: e => {
        ...
        workletOnIndexDecimalChange({
          indexDecimal: indexDecimal.value,
          tabName,
        });
      },
    });
