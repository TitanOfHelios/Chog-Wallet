...
export const StartupPerformanceLogViewer = registerAppScreen<
  typeof import('@/screens/Testkits/StartupPerformanceLogViewer').default
>({
  loader: () => import('@/screens/Testkits/StartupPerformanceLogViewer'),
  name: TESTKITS_PRELOAD_SCREENS.StartupPerformanceLogViewer,
});
