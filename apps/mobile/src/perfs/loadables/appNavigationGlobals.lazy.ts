...
export const FloatingStartupTaskSummaryPanel = registerAppScreen<
  typeof import('@/screens/Settings/components/FloatingStartupTaskSummaryPanel').FloatingStartupTaskSummaryPanel
>({
  loader: () =>
    import(
      '@/screens/Settings/components/FloatingStartupTaskSummaryPanel'
    ).then(m => ({
      default: m.FloatingStartupTaskSummaryPanel,
    })),
});
