...
class SignatureManagerRegistry {
   ...
   * Safe to call during render -- snapshot is updated synchronously so
   * getSnapshot() returns the correct value immediately, but listener
   * notification is batched via microtask to avoid "setState during render".
   */
