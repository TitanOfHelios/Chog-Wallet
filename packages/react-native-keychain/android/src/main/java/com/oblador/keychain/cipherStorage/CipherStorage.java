...
public interface CipherStorage {
  ...
  /** Decrypt with an explicit Android prompt policy when the storage supports it. */
  default void decryptWithPromptPolicy(@NonNull final DecryptionResultHandler handler,
                                       @NonNull final String alias,
                                       @NonNull final byte[] username,
                                       @NonNull final byte[] password,
                                       @NonNull final SecurityLevel level,
