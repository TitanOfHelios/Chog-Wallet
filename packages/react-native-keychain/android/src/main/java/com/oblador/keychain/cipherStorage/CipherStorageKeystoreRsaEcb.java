...
import com.rabbywallet.keychain.KeychainModule;
...
import com.rabbywallet.keychain.decryptionHandler.DecryptionResultHandlerNonInteractive;
...
public class CipherStorageKeystoreRsaEcb extends CipherStorageBase {
  ...
  @SuppressLint("NewApi")
  public void decryptWithPromptPolicy(@NonNull DecryptionResultHandler handler,
                                      @NonNull String alias,
                                      @NonNull byte[] username,
                                      @NonNull byte[] password,
                                      @NonNull final SecurityLevel level,
