...
@implementation RNRabbyKeychainManager

@synthesize bridge = _bridge;
RCT_EXPORT_MODULE(RNRabbyKeychainManager);
...
{
  return dispatch_queue_create("com.rabbywallet.KeychainQueue", DISPATCH_QUEUE_SERIAL);
}
